    ...
    <div className="center-view animate-fade-in" style={{ padding: '1.5rem 0.5rem' }}>
      <Card style={{ maxWidth: '460px', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: '1.2rem' }}>
          <h2>{t('patientLoginTitle')}</h2>
          <p style={{ fontSize: 'var(--font-size-sm)', color: 'var(--text-muted)' }}>
            Sign in to access your assistive speech platform.
          </p>
        </div>
      ...
      {showForgotModal && (
        <div style={{
          ...
          <div className="glass-card animate-fade-in" style={{ maxWidth: '400px', width: '100%', textAlign: 'center' }}>
            <HelpCircle size={36} color="var(--color-blue)" style={{ marginBottom: '1rem' }} />
            <h3>Reset Password</h3>
            <p style={{ fontSize: 'var(--font-size-sm)', marginBottom: '1.5rem' }}>
              Please contact your healthcare provider or caregiver to assist with resetting your account credentials.
            </p>
            <Button onClick={() => setShowForgotModal(false)} style={{ width: '100%' }}>
              Close
            </Button>
          </div>
        </div>

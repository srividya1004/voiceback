      ...
      <div className="mobile-container auth-container">
        ...
        <main className="role-main" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', width: '100%', alignItems: 'center' }}>
          ...
          <div className="role-title-section text-center" style={{ marginTop: '0.5rem', marginBottom: '0.5rem' }}>
            ...
            <h1 className="role-main-title">Caregiver Login</h1>
            <p className="role-subtitle">
              Sign in to your caregiver portal account to support your loved one.
            </p>
          </div>
          ...
          <section className="profile-section-card" style={{ width: '100%', gap: '1.15rem' }}>
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '100%' }}>
              ...
              <button
                ...
                style={{ width: '100%', background: 'var(--color-orange-primary)', marginTop: '0.25rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}
              >
                <Heart size={18} />
                <span>Login</span>
              </button>
            ...
            <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem', textAlign: 'center', width: '100%' }}>
              ...
              <button
                ...
                style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', color: 'var(--color-orange-primary)', borderColor: 'rgba(234, 88, 12, 0.4)' }}
              >
                <UserPlus size={18} />
